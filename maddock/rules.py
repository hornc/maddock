...
rules = {
        ...
        'innevent': ['#animalsound#', '#innevent#. #innevent#', 'A patron #adverb# spills #adjective.a# drink #beside# the #innloc#', 'A small fight breaks out over by the #innloc#',
                ...
                'The #staff# is called away #direction#', '#someone# storms off #direction#', '#someone# is excused #adverb# #direction#',
                'The #company# remark upon #remarkable#',
                '#someone# #moves# #adverb# into #stacked# and curses loudly; "#ctexclaim#"',
...
# Presently the Innkeeper (or possibly another staff member such as the vinter or pot-scrubber) undulates over to take their orders. Available impressive offerings are listed, questioned, and chosen; comprising and/or consisting of food and / or drinks. There is indecision, and certainty. Once all orders are made, the group settles in to wait. Drinks may arrive, but the food takes time to prepare.
        ...
        'descinnk': '\nThe innkeeper, #ik#, has a #ikpersonality# #pfeature#, and some #inndchoice# #inndimpart# to impart.',
        'pfeature': ['personality', 'visage', 'face', 'nose', 'bearing', 'manner'],
